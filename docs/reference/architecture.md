...
| `@hypha/domain`         | `DomainPackSpec`, Domain pipeline and capability bindings, `ReasoningSpec`, session initialization, local pack loading, overlays, registry, and compiler.        | Harness FSM topology, business-specific core code, or app routes.              |
