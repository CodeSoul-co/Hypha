...
| Result reuse            | bounded memory or Redis `ToolResultCache` and versioned validity records                                | Reuse is key-bound, runtime-validated, revision/policy/scope-aware, and restricted to safe side-effect levels.    |
