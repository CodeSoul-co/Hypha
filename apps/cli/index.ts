 ...
 * does NOT re-implement runtime logic such as chat, auth, memory, or workflow
 * execution. Every command funnels through apps/cli/http.ts and hits the
 * same public endpoints a web or mobile client would use.
 *
 * Subcommands live in apps/cli/commands/*. Add a new command by creating a
