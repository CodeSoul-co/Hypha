...
| 包 | 主要边界 | 常用入口 |
| --- | --- | --- |
| [`hypha-core`](./core) | 版本化 Framework 契约 | `createFrameworkEvent` |
| [`hypha-storage`](./storage) | Provider-neutral 存储 Profile | `createSQLiteStorageProfile` |
| [`hypha-fsm`](./fsm) | 校验后的 FSM 拓扑/运行时 | `parseFSMProcessSpec` |
| [`hypha-kernel`](./kernel) | ReAct 推理契约 | `reactAgentSpecDefinition` |
| [`hypha-harness`](./harness) | Event-first 执行与投影 | `SessionProjector` |
| [`hypha-models`](./models) | Model Provider 与路由 | `ModelRegistry` |
| [`hypha-inference`](./inference) | 标准化推理后端 | `InferenceManager` |
| [`hypha-memory`](./memory) | 受治理的作用域 Memory | `memorySpecDefinition` |
| [`hypha-skills`](./skills) | 渐进式指令加载 | `SkillRegistry` |
| [`hypha-tools`](./tools) | 类型化 Tool 执行 | `ToolRegistry` |
| [`hypha-mcp`](./mcp) | 受治理 MCP 集成 | `mcpIntegrationSpecDefinition` |
| [`hypha-domain`](./domain) | Domain Pack 编译 | `compileDomainPackToHarnessedSystem` |
| [`hypha-adapters-local`](./adapters-local) | 本地 Provider 组合 | `createLocalStorageBackbone` |
| [`hypha-serving-cache`](./serving-cache) | 作用域响应缓存 | `ServingCacheManager` |
| [`hypha-testing`](./testing) | Replay/回归辅助 | `assertStatePath` |
