...
| --- | --- | --- | --- |
| `ArtifactStoreAdapterError` | class | <code>new ArtifactStoreAdapterError(normalizedError: NormalizedArtifactError): ArtifactStoreAdapterError</code> | Runtime implementation for Artifact Store Adapter Error; see its public constructor and members below. |
| `artifactStoreError` | function | <code>artifactStoreError(code: NormalizedArtifactError["code"], message: string, retryable: boolean, details?: Record&lt;string, unknown&gt;): ArtifactStoreAdapterError</code> | Public runtime operation for artifact Store Error. |
| `validateArtifactStoreInput` | function | <code>validateArtifactStoreInput&lt;T&gt;(validate: () =&gt; T): T</code> | Validates Artifact Store Input at this module boundary. |

## `ArtifactStoreAdapterError` public members
