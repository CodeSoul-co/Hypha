...
const contractPairs: ContractSchemaPair[] = [
  ...
  ['ArtifactTraceLineageRequest', artifactTraceLineageRequestSchema],
  ['ArtifactLatestRequest', artifactLatestRequestSchema],
  ['ArtifactPreviousRequest', artifactPreviousRequestSchema],
